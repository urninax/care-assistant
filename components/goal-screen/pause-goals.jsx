...
export const PauseGoals = () => {
  const { scheme } = useContext(ThemeContext);

  const [goals, setGoals] = useState([]); // Liste der pausierten Ziele
  ...
  const [newGoalName, setNewGoalName] = useState(""); // Name des bearbeiteten Ziels
  ...
  const renderGoalItem = ({ item }) => (
    <View style={styles.goalItem}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity onPress={() => moveGoal(item.id, "CurrentGoals")}>
